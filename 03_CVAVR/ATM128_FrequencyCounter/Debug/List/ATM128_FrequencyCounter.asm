...
_0x0:
	.DB  0x4F,0x4E,0x20,0x0,0x4F,0x46,0x46,0x0
	.DB  0x25,0x2D,0x38,0x75,0x20,0x48,0x7A,0x0
	.DB  0x46,0x72,0x65,0x71,0x75,0x65,0x6E,0x63
	.DB  0x79,0x20,0x4D,0x65,0x74,0x65,0x72,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 003F  pulsa= (iterasiCounter3 * 50000) + ((long)TCNT3H * 256) + (long)TCNT3L; //jumlah pulsa dalam 50 ms
	LDS  R30,_iterasiCounter3
	LDS  R31,_iterasiCounter3+1
	LDS  R22,_iterasiCounter3+2
	LDS  R23,_iterasiCounter3+3
	__GETD2N 0xC350
	CALL __MULD12U
	PUSH R23
	PUSH R22
...
; 0000 0051  iterasiCounter3++;
	LDI  R26,LOW(_iterasiCounter3)
	LDI  R27,HIGH(_iterasiCounter3)
	CALL __GETD1P_INC
	__SUBD1N -1
	CALL __PUTDP1_DEC
; 0000 0052 }
...
SUBOPT_0x2:
	...
	STS  137,R30
	STS  136,R30
	STS  _iterasiCounter3,R30
	STS  _iterasiCounter3+1,R30
	STS  _iterasiCounter3+2,R30
	STS  _iterasiCounter3+3,R30
	LDI  R30,LOW(10)
	OUT  0x2E,R30
	LDI  R30,LOW(14)
	STS  138,R30
