...
TCCR1B=0x00; //matikan timer terlebih dahulu
TCNT1H=0x00;
TCNT1L=0x00;
ICR1H=0x00;
ICR1L=0x00;
...
while (1)
      {
      // Place your code here
      while (start_bit)             //while (start_bit==1)
      {
        lcd_clear();
        PORTB= proses_isi;
        lcd_putsf("Proses Isi....");
        start_timer();
        while(TANKFUL){ };          //tunggu sampai TANKFUL=0
        stop_timer();
        lcd_gotoxy(0,1);
        lcd_putsf("Sukses....!");
        delay_ms(1000);
        ...
        lcd_clear();
        PORTB= proses_panas;
        lcd_putsf("Proses Panas....");
        start_timer();
        while(~TEMPOK){ };          //tunggu sampai TEMPOK=1
        stop_timer();
        lcd_gotoxy(0,1);
        lcd_putsf("Sukses....!");
        delay_ms(1000);
