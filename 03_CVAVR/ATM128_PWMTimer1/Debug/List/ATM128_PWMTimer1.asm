...
; 0000 005A // Mode: Ph. correct PWM top=ICR1
; 0000 005B // OC1A output: Non-Inverted PWM
; 0000 005C // OC1B output: Inverted PWM
; 0000 005D // OC1C output: Non-Inverted PWM
; 0000 005E // Noise Canceler: Off
; 0000 005F // Input Capture on Falling Edge
; 0000 0060 // Timer Period: 20 ms
; 0000 0061 // Output Pulse(s):
; 0000 0062 // OC1A Period: 20 ms Width: 1 ms// OC1B Period: 20 ms Width: 1.4992 ms// OC1C Period: 20 ms Width: 2 ms
...
; 0000 0067 // Compare C Match Interrupt: Off
; 0000 0068 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (1<<COM1B0) | (1<<COM1C1) | (0<<COM1C0) | (1<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(186)
	OUT  0x2F,R30
; 0000 0069 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (1<<WGM13) | (0<<WGM12) | (0<<CS12) | (1<<CS11) | (0<<CS10);
	LDI  R30,LOW(18)
	OUT  0x2E,R30
...
; 0000 006B TCNT1L=0x00;
	OUT  0x2C,R30
; 0000 006C ICR1H=0x30;
	LDI  R30,LOW(48)
	OUT  0x27,R30
; 0000 006D ICR1L=0xD4;
	LDI  R30,LOW(212)
	OUT  0x26,R30
; 0000 006E OCR1AH=0x02;
	LDI  R30,LOW(2)
	OUT  0x2B,R30
; 0000 006F OCR1AL=0x71;
	LDI  R30,LOW(113)
	OUT  0x2A,R30
; 0000 0070 OCR1BH=0x2D;
	LDI  R30,LOW(45)
	OUT  0x29,R30
; 0000 0071 OCR1BL=0x2B;
	LDI  R30,LOW(43)
	OUT  0x28,R30
; 0000 0072 OCR1CH=0x04;
	LDI  R30,LOW(4)
	STS  121,R30
; 0000 0073 OCR1CL=0xE2;
	LDI  R30,LOW(226)
	STS  120,R30
; 0000 0074 
...
; 0000 007C OCR2=0x00;
	OUT  0x23,R30
; 0000 007D 
; 0000 007E // Timer/Counter 3 initialization
; 0000 007F // Clock source: System Clock
; 0000 0080 // Clock value: Timer3 Stopped
; 0000 0081 // Mode: Normal top=0xFFFF
; 0000 0082 // OC3A output: Disconnected
; 0000 0083 // OC3B output: Disconnected
; 0000 0084 // OC3C output: Disconnected
; 0000 0085 // Noise Canceler: Off
; 0000 0086 // Input Capture on Falling Edge
; 0000 0087 // Timer3 Overflow Interrupt: Off
...
; 0000 008C TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	STS  139,R30
; 0000 008D TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
; 0000 008E TCNT3H=0x00;
	STS  137,R30
; 0000 008F TCNT3L=0x00;
	STS  136,R30
; 0000 0090 ICR3H=0x00;
	STS  129,R30
; 0000 0091 ICR3L=0x00;
	STS  128,R30
; 0000 0092 OCR3AH=0x00;
	STS  135,R30
; 0000 0093 OCR3AL=0x00;
	STS  134,R30
; 0000 0094 OCR3BH=0x00;
	STS  133,R30
; 0000 0095 OCR3BL=0x00;
	STS  132,R30
; 0000 0096 OCR3CH=0x00;
	STS  131,R30
; 0000 0097 OCR3CL=0x00;
	STS  130,R30
; 0000 0098 
...
; 0000 00A4 // INT6: Off
; 0000 00A5 // INT7: Off
; 0000 00A6 EICRA=(0<<ISC31) | (0<<ISC30) | (0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  106,R30
; 0000 00A7 EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 00A8 EIMSK=(0<<INT7) | (0<<INT6) | (0<<INT5) | (0<<INT4) | (0<<INT3) | (0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x39,R30
; 0000 00A9 
; 0000 00AA // USART0 initialization
; 0000 00AB // USART0 disabled
; 0000 00AC UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	OUT  0xA,R30
; 0000 00AD 
; 0000 00AE // USART1 initialization
; 0000 00AF // USART1 disabled
; 0000 00B0 UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	STS  154,R30
; 0000 00B1 
...
; 0000 00BD ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00BE 
...
; 0000 00CA       for (i=625;i<=1250;i=i+10)
	LDI  R30,LOW(625)
	LDI  R31,HIGH(625)
	MOVW R4,R30
_0x7:
...
; 0000 00D0         };
	...
	RJMP _0x7
_0x8:
; 0000 00D1       for (i=1250;i>=625;i=i-10)
	LDI  R30,LOW(1250)
	LDI  R31,HIGH(1250)
	MOVW R4,R30
_0xA:
