...
_0x0:
	.DB  0x41,0x44,0x43,0x20,0x3D,0x20,0x25,0x33
	.DB  0x64,0x0,0x44,0x41,0x43,0x20,0x3D,0x20
	.DB  0x25,0x33,0x2E,0x32,0x66,0x20,0x56,0x0
_0x2000000:
...
; 0000 007B       sprintf(textbuff1, "ADC = %3d", data_adc);
	LDI  R30,LOW(_textbuff1)
	LDI  R31,HIGH(_textbuff1)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
...
; 0000 007C       lcd_puts(textbuff1);
	LDI  R26,LOW(_textbuff1)
	LDI  R27,HIGH(_textbuff1)
	CALL _lcd_puts
; 0000 007D 
...
; 0000 0081       sprintf(textbuff2, "DAC = %3.2f V", avalue);
	LDI  R30,LOW(_textbuff2)
	LDI  R31,HIGH(_textbuff2)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,10
	ST   -Y,R31
...
; 0000 0082       lcd_puts(textbuff2);
	LDI  R26,LOW(_textbuff2)
	LDI  R27,HIGH(_textbuff2)
	CALL _lcd_puts
