...
_0x0:
	.DB  0x25,0x31,0x2E,0x32,0x66,0x20,0x56,0x20
	.DB  0x2D,0x2D,0x20,0x25,0x31,0x2E,0x32,0x66
	.DB  0x20,0x56,0x0,0x53,0x65,0x6C,0x69,0x73
	.DB  0x69,0x68,0x20,0x3D,0x20,0x25,0x31,0x2E
...
; 0000 0089       data_adc0 = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	LDI  R26,LOW(_data_adc0)
	LDI  R27,HIGH(_data_adc0)
	CALL SUBOPT_0x0
; 0000 008A       tegangan0 = data_adc0*4/1023;
	LDS  R26,_data_adc0
	LDS  R27,_data_adc0+1
	LDS  R24,_data_adc0+2
	LDS  R25,_data_adc0+3
	CALL SUBOPT_0x1
	STS  _tegangan0,R30
	STS  _tegangan0+1,R31
	STS  _tegangan0+2,R22
	STS  _tegangan0+3,R23
; 0000 008B       data_adc1 = read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	LDI  R26,LOW(_data_adc1)
	LDI  R27,HIGH(_data_adc1)
	CALL SUBOPT_0x0
; 0000 008C       tegangan1 = data_adc1*4/1023;
	LDS  R26,_data_adc1
	LDS  R27,_data_adc1+1
	LDS  R24,_data_adc1+2
	LDS  R25,_data_adc1+3
	CALL SUBOPT_0x1
	STS  _tegangan1,R30
	STS  _tegangan1+1,R31
	STS  _tegangan1+2,R22
	STS  _tegangan1+3,R23
; 0000 008D 
...
; 0000 008F       sprintf(LCDBuffer,"%1.2f V -- %1.2f V", tegangan0, tegangan1);
	...
	CALL __PUTPARD1
	LDS  R30,_tegangan1
	LDS  R31,_tegangan1+1
	LDS  R22,_tegangan1+2
	LDS  R23,_tegangan1+3
	CALL __PUTPARD1
	LDI  R24,8
	CALL _sprintf
	ADIW R28,12
...
; 0000 0092       selisih = fabs(tegangan0-tegangan1);
	LDS  R26,_tegangan1
	LDS  R27,_tegangan1+1
	LDS  R24,_tegangan1+2
	LDS  R25,_tegangan1+3
	CALL SUBOPT_0x3
	CALL __SUBF12
	MOVW R26,R30
	MOVW R24,R22
...
SUBOPT_0x3:
	LDS  R30,_tegangan0
	LDS  R31,_tegangan0+1
	LDS  R22,_tegangan0+2
	LDS  R23,_tegangan0+3
	RET
