...
_0x3:
	.DB  0x14,0x14,0x14,0x46,0x49,0x53,0x49,0x4B
	.DB  0x41,0x2D,0x2D,0x55,0x49,0x14,0x14,0x14
_0x0:
	.DB  0x43,0x6F,0x75,0x6E,0x74,0x65,0x72,0x3D
	.DB  0x20,0x25,0x2D,0x35,0x64,0x0,0x43,0x61
	.DB  0x70,0x65,0x6B,0x20,0x64,0x65,0x68,0x2E
	.DB  0x2E,0x2E,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0114 sprintf(textbuffer,"Counter= %-5d", jumlah);
	LDI  R30,LOW(_textbuffer)
	LDI  R31,HIGH(_textbuffer)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
...
; 0000 0115 lcd_puts(textbuffer);
	LDI  R26,LOW(_textbuffer)
	LDI  R27,HIGH(_textbuffer)
	RCALL _lcd_puts
...
; 0000 0120         lcd_putchar(text_fis[i]);
	MOV  R30,R5
	LDI  R31,0
	SUBI R30,LOW(-_text_fis)
	SBCI R31,HIGH(-_text_fis)
	LD   R26,Z
	CALL SUBOPT_0x2
