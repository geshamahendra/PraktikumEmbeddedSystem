...
_0x0:
	.DB  0x42,0x61,0x63,0x61,0x20,0x41,0x44,0x43
	.DB  0x4D,0x50,0x33,0x32,0x30,0x34,0x0,0x53
	.DB  0x75,0x68,0x75,0x20,0x3D,0x20,0x25,0x35
	.DB  0x2E,0x33,0x66,0x20,0x43,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2040000:
...
; 0000 0051       Temperatur = (float)data/4096*500-55;
	...
	CALL SUBOPT_0x0
	STS  _Temperatur,R30
	STS  _Temperatur+1,R31
	STS  _Temperatur+2,R22
	STS  _Temperatur+3,R23
; 0000 0052       sprintf(text,"Suhu = %5.3f C",Temperatur);
	...
	ST   -Y,R30
	LDS  R30,_Temperatur
	LDS  R31,_Temperatur+1
	LDS  R22,_Temperatur+2
	LDS  R23,_Temperatur+3
	CALL __PUTPARD1
	LDI  R24,4
	CALL _sprintf
	ADIW R28,8
