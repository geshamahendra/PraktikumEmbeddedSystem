...
unsigned char read_keypad(void)
{
 ...
 PORTD= 0xFF; PORTD.4= 0;\
 key_index= (~PIND & 0x0F); //masking (tutupi 4 bit atas yang tidak diperlukan D4-D7)
                            //misal tombol 1 ditekan. PIND= 1111 1110
                            //~PIND= 0000 0001; ~PIND & 0x0F= 0000 0001
...
while (1)
      ...
      delay_ms(200);
        ...
        lcd_puts(text);
        lcd_gotoxy(0,1);
        if (digit == 10) lcd_putsf("Direction: Left");
